	...
	return (
		<div>
			...
			<div className="relative z-20 container mx-auto p-6 text-white">
				<h1 className="text-4xl font-bold text-center mb-6">DAO Information</h1>
				...
				<Link href="/explorer">
					<button className="fixed bottom-4 left-4 bg-red-500 text-white px-4 py-2 rounded-xl shadow-lg hover:bg-red-600 transition">
						Back to Home
					</button>
				</Link>
			</div>
